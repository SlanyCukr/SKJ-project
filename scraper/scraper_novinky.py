...
def process_portion_of_articles(stalo_se_articles, original_article_len: int):
    browser = mechanicalsoup.StatefulBrowser()

    for article_url in stalo_se_articles:
        progress = int((1 / original_article_len) * 100)

        # skip not article
        if 'lastItem' in article_url:
